...
Git.prototype.getUsersList = function (since) {
    "use strict";
    var that = this,
        usersList = new that.Ajax("GET", "https://api.github.com/users", {
            since: since
        });
...
Git.prototype.getUserInfoWithLocation = function (location, sort, startpage) {
    "use strict";
    var that = this,
        userInfo = new that.Ajax("GET", "https://api.github.com/legacy/user/search/location:" + location + "?type=user", {
            start_page: startpage,
            sort: sort,
            access_token: "8e2cd2c3b60bd174564635b04b8df1b42f4e8d44"
        });
...
Git.prototype.getUserInfo = function (userLogin) {
    "use strict";
    var that = this,
        userInfo = new that.Ajax("GET", "https://api.github.com/users/" + userLogin, {
            access_token: "8e2cd2c3b60bd174564635b04b8df1b42f4e8d44"
        });
    return userInfo;
};
...
Git.prototype.init = function () {
    ...
    var that = this,
        userInfo = that.getUserInfoWithLocation("turkey", "repositories", 1);
